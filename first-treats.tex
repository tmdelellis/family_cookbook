...
\begin{center}
\includegraphics[scale=.5,clip]{figures/pound}
\end{center}
...
\textit{Kate: On his/her birthday most kids I knew asked for chocolate cake,
...
\centering\includegraphics[width=.22\textwidth,clip]{figures/kiss}
\end{wrapfigure}
