...
\section{Frog Mustard Salad Dressing\index{appetizers and salads!frog mustard
salad dressing}}
\index{Evans!Kate}
...
\centering\includegraphics[width=.42\textwidth,clip]{figures/frog}
\end{wrapfigure}
...
\section{Meaty Cheese dip, aka "Queso"\index{appetizers and salads!meaty cheese dip}}
\index{Evans!Kate}

\begin{open}
  Just so you know, this dish isn't good for you. But it's so delicious,
  we don't care. Kate originally got this recipe from \corp{Southern Living}, but has
since improved it using input from our dear friend Dave Court\index{Court, Dave}.  For you
  food snobs, don't be put off by the \corp{Velveeta}.  It provides a
...
\section{Hot crab dip\index{appetizers and salads!hot crab dip}}
\index{Johnson!Dodge}
...
\section{Blue Cheese-Pecan Spread\index{appetizers and salads!blue cheese-pecan
spread}}
\index{Johnson!Dodge}
\index{Johnson!Martha}
