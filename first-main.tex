...
%%
\begin{center}
  \includegraphics[width=.40\textwidth]{figures/chilli.pdf}
\end{center}
...
is needed.
\begin{center}
    \includegraphics[scale=.65,clip]{figures/meatloaf.pdf}
\end{center}
\end{entry}
...
\begin{center}
    \includegraphics[width=.5\textwidth,clip]{figures/crab.pdf}
\end{center}
\end{entry}
