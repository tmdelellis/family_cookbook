...
\begin{open}
  This is a recipe from Lil and Don Johnson.  Grammie (Lil) passed it to
  Martha, who passed it to Kate, and so on, and so on, and so on\textellipsis
  It's good.
\end{open}
\begin{ingredients}
...
\begin{open}
  This from Kate's brother Don, and he got it from his friend Dawn Ollila. The
  honey/brown sugar and cinnamon addition is what makes it taste so special.
\end{open}
\begin{ingredients}
  \SI{1}{\tblspoon}olive oil \\
  1 onion \\
...
\begin{open}
  ...
  Nicolson's. It's a great dish for company-especially at their house because
...
\end{ingredients}
%
\protip{An addition to the second addition is that using fresh
pineapple makes this dish so much better!}
%
